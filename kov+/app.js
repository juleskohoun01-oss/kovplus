...
function calculerCycle() {
  ...
  let conseil = "";
  if (age < 18) conseil = "Cycle souvent irrégulier à cet âge. Abstenez-vous entre le ${fertileStart} et le ${fertileEnd}";
  else if (age > 45) conseil = "Cycle potentiellement irrégulier en pré-ménopause.";
  else conseil = "Cycle régulier estimé.";
...
const utilisateur = {
  ...
  cycle: {
    ...
    ovulation: calculerDate(parseInt(document.getElementById("startDate").value), 14),
    fertile: {
      debut: calculerDate(parseInt(document.getElementById("startDate").value), 12),
      fin: calculerDate(parseInt(document.getElementById("startDate").value), 16)
    }
  }
};
